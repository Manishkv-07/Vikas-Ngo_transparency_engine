...
import { ShieldCheck, LayoutDashboard, FolderKanban, Receipt, FileText, LogIn, LogOut, HeartHandshake } from "lucide-react";
...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground relative">
      <LiquidCore />
      <header className="sticky top-0 z-30 border-b bg-card/40 backdrop-blur-md">
